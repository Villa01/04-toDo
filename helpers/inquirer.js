...
const questions = [
    {
        ...
        choices: [
            ...
            {
                value: '2',
                name: `${'2.'.green} List to do's.`
            },
            {
                value: '3',
                name: `${'3.'.green} List to accomplished do's. `
            },
            {
                value: '4',
                name: `${'4.'.green} List to pending do's. `
            },
            {
                value: '5',
                name: `${'5.'.green} Accomplish to do's.`
            },
            {
                value: '6',
...
const listDeleteToDo = async(toDos = []) => {
    const choices = toDos.map( ({id, desc}, i) => {
